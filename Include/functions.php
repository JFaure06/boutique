...
function afficheCatalogue($articles)
{
    ...
    <div class="col-md-6">
        <div class="card text-center shadow p-3 mb-5 bg-grey rounded" style="width: 50rem;">
            <a href="article.php?id=<?php echo $articles["idArticle"]; ?>">
                <img src="photo/Catalogue/Ski/<?php echo $articles["Image"]; ?>" class="card-img-top img-article"
                     alt="photo_Ski">
...
function articlePanier($panier, $quantite)
{
    ...
    <div class="d-flex justify-content-center">
        <div class="card text-center shadow p-3 mb-5 bg-grey rounded row" style="width: 50rem;">
            ...
            <input type="hidden" name="<?php echo $panier["idArticle"]; ?>" id="<?php echo $panier["idArticle"]; ?>" value="on"
                   class="container-fluid d-flex justify-align-center"/>
            <input type="submit" value="delete" name="delete<?php echo $panier["idArticle"]; ?>" class="btn btn-danger w-25">
        </div>
    </div>
